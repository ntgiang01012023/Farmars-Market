  ...
  return (
    <>
      <div className='header w-full h-auto'>
        <div className='w-full h-[40px] bg-greenPrimary'>
        ...
        <div className='w-full h-auto py-[24px]'>
          <div className='w-[1280px] h-full m-auto flex justify-between items-center'>
            <div className='logo'>
              <img className='w-[250px] h-auto object-cover' src={Logo} alt='Logo' />
            </div>
        ...
        <div className='w-full h-auto border border-b-grayDark'>
          <div className='w-[1280px] h-full m-auto flex justify-between items-center'>
            ...
            <div className=''>
              <Link className='flex justify-center items-center gap-[12px] text-[16px] text-greenPrimary font-semibold bg-greenLight px-[20px] py-[12px] rounded-[5px]'>
                <img className='w-[24px] h-[24px]' src={IconDeal} alt="Icon Deal" />
                Ưu đãi hôm nay
              </Link>
            </div>
          </div>
