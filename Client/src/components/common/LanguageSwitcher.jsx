...
export default function LanguageSwitcher() {
    ...
    return (
        <>
            ...
            >
                <img className='w-[20px] h-[15px] object-cover' src={selectLanguages === 'vi' ? LanguageVietNam : LanguageEnglish} alt="vi" />
                {selectLanguages === 'vi' ? <span>Vietnamese</span> : <span>English</span>}
            ...
            {showSelect && (
                <div className="z-40 absolute top-[40px] right-0 w-[160px] h-auto bg-white border-[1px] border-rgba(0,0,0,0.15) rounded-[5px] transition-opacity opacity-500">
                    <ul className="p-[12px]">
                        ...
                        >
                            <img className='w-[20px] h-[15px] object-cover' src={LanguageVietNam} alt="vi" />
                            <span>Vietnamese</span>
                            {selectLanguages === 'vi' && <i className="fa-solid fa-check text-greenPrimary"></i>}
                        </button>
                        <button
                        ...
                        >
                            <img className='w-[20px] h-[15px] object-cover' src={LanguageEnglish} alt="vi" />
                            <span>English</span>
                            {selectLanguages === 'en' && <i className="fa-solid fa-check text-greenPrimary"></i>}
                        </button>
                    </ul>
                </div>
            )}
